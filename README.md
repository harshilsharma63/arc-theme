![Arc-Dark vs Arc-Black comparision](http://i.imgur.com/eaidc2I.jpg)

# Arc Black

Arc-Black is a black (very dark gray actually) version of Arc-Dark theme provided in original package.
I created this theme because Arc-Dark is not at all dark and used dark blue instead of true dark
color, which started to hurt my eye.
...
After the installation is complete the theme can be activated with `gnome-tweak-tool` or a similar program by selecting `Arc`, `Arc-Darker` or `Arc-Black` as Window/GTK+ theme and `Arc` or `Arc-Black` as GNOME Shell/Cinnamon theme.
...
For more information refer the original documentation available below.
